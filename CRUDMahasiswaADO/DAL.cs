...
namespace CRUDMahasiswaADO
{
    public class DAL
    {
        public static string GetLoaclIPAddress()
        {
        ...
        {
            string connectionString = $"Data Source={GetLoaclIPAddress()}\\NIMRA;Initial Catalog=DBAkademikADO;Integrated Security=True;";
        ...
        public DataTable getProdi()
        {
            ...
            SqlCommand cmd = new SqlCommand("select NamaPS from programstudi", conn);
